...
export default function Intro () {
    ...
    return (
            <div className="flex flex-col items-center justify-center">    
                    ...
                    <div className={`flex flex-col-reverse justify-center items-center gap-6 2xl:flex-column xl:max-w-xl 2xl:flex-row 2xl-max-w-2xl`}>
                        <ImageCard
                    ...
                    <div className="bg-linear-to-b from-transparent to-[#101010] w-screen p-6 rounded-lg flex flex-col justify-center items-center gap-1 shadow-lg">
                        <Title
                            maxWidth={titleMaxWidth}
                            size={titleSize}
                    ...
                    <div className={`flex flex-col-reverse justify-center items-center gap-6 2xl:flex-column xl:max-w-xl 2xl:flex-row-reverse 2xl-max-w-2xl`}>
