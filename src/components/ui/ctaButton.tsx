...
export default function CtaButton({price, previousPrice}: ctaButtonProps) {
    return(
        <div className="flex flex-col items-center justify-center bg-radial from-[#f5c54257] via-[#f5c54111] to-transparent w-screen p-10">
            ...
            <button className="bebas text-3xl md:text-6xl p-3 bg-[#B81D24] hover:bg-[#922121] transition-colors border-3 rounded-sm shadow-2xl">
                <a href="https://w.app/g-flux" className="cursor:pointer animate-none" target="_blank" rel="noopener noreferrer">¡Empieza hoy por ${price}!
                </a>
            </button>
        </div>
